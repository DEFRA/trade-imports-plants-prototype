...
describe('#resultsHref', () => {
  it('Should carry the search term, the page and the ticked row', () => {
    expect(
      ...
      `${SET_BASE}/notifications/${JOURNEY_ID}/destinations/select?q=imports&page=3&selected=${TECH_IMPORTS_ID}`
    )
  })
  ...
  it('Should leave out a search term and a selection it does not have', () => {
    ...
    ).toBe(`${SET_BASE}/notifications/${JOURNEY_ID}/destinations/select?page=2`)
  })
})
